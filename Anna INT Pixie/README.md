...
It will probably come as no surprise that the **INT** module also expects a *machine zero* reference as input. Like the **ADD** module, *machine zero* (ZERO) is used as a *virtual ground* on the non-inverting input.
